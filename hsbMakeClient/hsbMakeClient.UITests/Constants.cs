namespace hsbMakeClient.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "com.hsbcad.hsbMakeClientAppUno";
    public readonly static string AndroidAppName = "com.hsbcad.hsbMakeClientAppUno";
